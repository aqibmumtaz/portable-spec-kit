...
[![Version](https://img.shields.io/badge/version-v0.6.55-blue.svg)](portable-spec-kit.md)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
[![Tests](https://img.shields.io/badge/tests-2352%20passing-brightgreen.svg)](tests/)
...
Installs: `portable-spec-kit.md` (~980 lines) · 32 reliability scripts (required) + 6 optional helpers — 38 total `.sh` files in `agent/scripts/` · 25 skill files (JIT-loaded) · 23 file-class templates (`.portable-spec-kit/templates/`) · 24 flow documents (`docs/work-flows/`) · 4 stack-aware CI templates · PreCommit + PostToolUse hooks · symlinks for all supported agents.
