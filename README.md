...
[![Version](https://img.shields.io/badge/version-v0.6.82-blue.svg)](portable-spec-kit.md)
...
Installs: `portable-spec-kit.md` (~1100 lines) · 52 `psk-*` reliability scripts + 3 helper scripts (install-tracker, sync, uninstall-tracker) — 55 total `.sh` files in `agent/scripts/` · 29 skill files (JIT-loaded) · 24 file-class templates (`.portable-spec-kit/templates/`) · 32 flow documents + 1 template (`docs/work-flows/`, 33 `.md` files) · 4 stack-aware CI templates · PreCommit + PostToolUse hooks · symlinks for all supported agents.
