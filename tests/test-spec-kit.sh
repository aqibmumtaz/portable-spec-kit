...
grep -q "TASKS.md is single source of truth" "$PROJ/portable-spec-kit.md" \
...
grep -qi "design decision compliance\|agent/design/" "$PROJ/portable-spec-kit.md" \
...
grep -qi "stack auto-detected\|Stack auto-detect" "$PROJ/portable-spec-kit.md" \
...
grep -q "check scope" "$PROJ/portable-spec-kit.md" \
...
grep -qi "advisory.*session\|Advisory at session" "$PROJ/portable-spec-kit.md" \
